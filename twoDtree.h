...
public:
   ...
   * splitting lines. It will also call helper function buildTree.
    ...
    */
   PNG render();
   void renderHelper(PNG &im, Node* currNode);
   ...
   * You may want a recursive helper function for this one.
    */
   void prune(int tol);
   int compareColors(int tol, RGBAPixel color, RGBAPixel avg);
   void pruneHelper(Node* currNode, int tol);
   int shouldPrune(Node* currNode, int tol, RGBAPixel avg);
   ...
   * You may want a recursive helper function for this one.
   ...
   int pruneSizeHelper(Node* currNode, int tol);
...
private:
   ...
   */
   ...
   void copyHelper(Node * origNode, Node* currNode);
